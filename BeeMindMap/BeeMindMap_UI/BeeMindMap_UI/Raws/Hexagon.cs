...
{
    public class Hexagon : Guna2Panel
    {
...
/*                                  new Point(Main.Width/4, 0),
                                  new Point(Main.Width /4 * 3,0),
                                  new Point(Main.Width,Main.Height/2),
                                  new Point(Main.Width/4*3, Main.Height),
                                  new Point(Main.Width/4, (Main.Height)),
